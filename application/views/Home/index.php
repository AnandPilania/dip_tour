                ...
                <div class="container newsletter-bg-colour" style="
                     ...
                     "> <form>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2 ">
                                <a href="contact.php" class="theme-btn btn-2" role="button"  style="background-color: green; text-align: center;"   type="button">SEARCH</a>
                            </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="new">
                            <div class="row">
								...
								<form method="post" action="<?php echo base_url('/Home/add');?>" enctype="multipart/form-data"/>
