...
h3{
  ...
  <form id= "newsletter" class="contact-form" enctype="multipart/form-data" action="<?php echo base_url();?>Dashboard/updateNewsletter" method="post">
        ...
        <div class="box-body">
            ...
            <div class="col-md-4 col-12">
              ...
              <div class="form-group">
					...
					<div class="controls">
						<input type="text" name="newsletter_title" class="form-control" required="" data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="No Characters Allowed, Only Numbers" aria-invalid="false" value="<?php echo $val['newsletter_title'];?>"> 
            ...
            <div class="col-md-8 col-12" style="margin-top:10px;">
              <div class="form-group">
					...
					<div class="controls">
						<textarea  rows="4" cols="50" class="form-control"  name="newsletter_content" class="form-control"placeholder="Enter Description" required>
						<?php echo $val['newsletter_content'];?></textarea> 
						<div class="help-block">
						</div>
						</div>
				</div>
